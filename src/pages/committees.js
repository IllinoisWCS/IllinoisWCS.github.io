...
const values = {
  Infrastructure: [
    ...
    "assets/img/members/techteam.jpg",
  ],
  Corporate: [
    ...
    "assets/img/members/corporate.png",
  ],
  Explorations: [
    ...
    "assets/img/members/memberportal.jpg",
  ],
  Mentoring: [
    ...
    "assets/img/members/mentoring.jpg",
  ],
  Social: [
  ...
  Outreach: [
    ...
    "assets/img/members/outreach.jpg",
  ],
};
  ...
  return (
    <div className={`${styles.main}`}>
      ...
      <CommitteesSection
        ...
        isRight={false}
        name="Infrastructure"
        description={values["Infrastructure"][0]}
        officers={values["Infrastructure"][1]}
        color="#FB79C3"
        bColor="#FFCEE7"
        img={values["Infrastructure"][2]}
      ></CommitteesSection>
      <CommitteesSection
        isLeft={false}
        isRight={true}
        name="Corporate"
        description={values["Corporate"][0]}
        officers={values["Corporate"][1]}
        img={values["Corporate"][2]}
      ></CommitteesSection>
      <CommitteesSection
        isLeft={true}
        isRight={false}
        name="Explorations"
        description={values["Explorations"][0]}
        officers={values["Explorations"][1]}
        color="#FB79C3"
        bColor="#FFCEE7"
        img={values["Explorations"][2]}
      ></CommitteesSection>
      <CommitteesSection
        isLeft={false}
        isRight={true}
        name="Mentoring"
        description={values["Mentoring"][0]}
        officers={values["Mentoring"][1]}
        img={values["Mentoring"][2]}
      ></CommitteesSection>
      <CommitteesSection
        isLeft={true}
        isRight={false}
        name="Social"
        description={values["Social"][0]}
        officers={values["Social"][1]}
        color="#FB79C3"
        bColor="#FFCEE7"
        img={values["Social"][2]}
      ></CommitteesSection>
      <CommitteesSection
        ...
        isRight={true}
        name="Outreach"
        description={values["Outreach"][0]}
        officers={values["Outreach"][1]}
        img={values["Outreach"][2]}
      ></CommitteesSection>
    </div>
  );
}

$(document).ready(function() {
    ...
    var faq = {
        "questions": [
            ...
            },
            {
                "id": "when",
                "question": "When is it?",
                "answer": "Chictech will be held Nov. 12 - 13, 2016."
            },
            {
                "id": "cost",
            ...
            },
            {
                ...
                "answer": "Registration will open on October 3rd and will close on October 14th. The form to register on will be in the register section below."

            },
            {
                "id": "accept",
                "question": "How do I know if I'm accepted into the retreat?",
                "answer": "We will be sending out emails by October 21st with decisions about your acceptance. The spots will mostly be first come, first serve with some emphasis on the brief explanation about why you would like to attend our retreat."
            },
            {
                "id": "programming",
    ...
    var schedule117 = {
        "events": [
            {
                "time": "8:30 AM",
                "what": "Check-in & Breakfast & Photo booth",
                "where": "SC Atrium"
            },
            {
                "time": "9:30 AM",
                "what": "Welcome & Lean In Talk & Project Fair",
                "where": "SC 2405"
            },
            {
                "time": "10:30 AM",
            ...
            {
                "time": "12:00 PM",
                "what": "Lunch & Talk from a developer in the industry",
                "where": "SC 2405"
            },
            {
                "time": "1:00 PM",
            ...
            {
                "time": "6:00 PM",
                "what": "Dinner & talk by a professor",
                "where": "SC 2405"
            },
            {
                "time": "7:00 PM",
    ...
    var schedule118 = {
        "events": [
            ...
            {
                "time": "12:00 PM",
                "what": "Start project demos to parents",
                "where": "SC 0218/20/22"
            },
            {
                "time": "12:30 PM",
                "what": "Lunch (parents invited) and talk by current professor",
                "where": "SC 1404"
            },
            {
                "time": "1:30 PM",
                "what": "Wrap up and Closing Note",
                "where": "SC 2405"
            }
        ]
    };

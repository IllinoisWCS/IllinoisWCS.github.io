$(document).ready(function() {
    ...
    $.getJSON("../assets/js/chictech_schedule_day1.json", function(data) {
        var upcomingTemplate = Mustache.render($('#eventTemplate').html(), data);
        $('#agendaDay1').html(upcomingTemplate);
    });

    $.getJSON("../assets/js/chictech_schedule_day2.json", function(data) {
        var upcomingTemplate = Mustache.render($('#eventTemplate').html(), data);
        $('#agendaDay2').html(upcomingTemplate);
    });
